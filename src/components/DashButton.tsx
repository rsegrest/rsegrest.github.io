...
export const DashButton = ({
    ...
    <button
        onClick={onClick}
        className="relative group flex flex-col items-center gap-3 w-24 outline-none"
    >
        {/* Pill Light Indicator */}
        <div className={`w-10 h-3 rounded-full border border-black transition-all duration-300 ${active
        ...
        <div
            style={{ width: '7rem', marginLeft: '1rem', marginRight: '1rem' }}
        ...
        >
            ...
            <div className={
                `w-full py-3 px-2 rounded bg-gradient-to-b from-[#333] to-[#111] text-xs font-bold text-[#c5a059] uppercase tracking-widest border-b-4 border-black transition-all duration-100 ${active
